...
```bash
git remote add encore encore://user-role-app-4rq2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/user-role-app-4rq2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/user-role-app-4rq2/settings/integrations/github)
